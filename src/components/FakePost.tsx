export default function FakePost(props: {}) {
  return (
    <div className="animate-pulse container mx-2 sm:w-full h-82 md:w-72  bg-white shadow-md rounded p-3 pb-4">
      ...
      <div className=" rounded bg-gray-200 w-full h-2 my-2"></div>
      <div className=" rounded bg-gray-200 w-54 h-2 my-2"></div>
      <div className=" rounded bg-gray-200 w-64 h-2"></div>
    </div>
  );
}
